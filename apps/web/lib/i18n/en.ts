...
export const en: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Convert your PDF, Word, Excel, and image files securely.',
  ...
  toolsGrid: {
    ariaLabel: 'Available conversion tools',
  },
  ...
  pages: {
    ...
    privacy: {
      ...
      intro: 'This page describes what actually happens to your files and data when you use DosyaLab.',
